...
class DirectoryParser:
    ...
    def __init__(self, sql_ast_cls=SqlAst):
        ...
        self.edge_widths = {}  # Add a dictionary to store the width of the edges
                ...
                if file.endswith((".sql", ".ddl")):  # Support both SQL and DDL files
                    ...
                    try:
                        with open(file_path, "r", encoding="utf-8") as f:
                            ...
                            # Add a width calculation for the file
                            self._calculate_edge_widths(
                                file_path, ast.get_dependencies()
                            )
                            results.append(
                                (
