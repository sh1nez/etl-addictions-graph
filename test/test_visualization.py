...
#class TestFailingCases:
    ...
    #
    #         assert (
    #             "Missing table: non_existing_table" in result[0]
    #         ), "Нет валидации ссылок на таблицы"
    #
    #     def test_circular_dependency(self):
    #         """Тест должен упасть: циклическая зависимость"""
    #         manager = GraphManager()
    #         sqls = ["INSERT INTO A SELECT * FROM B;", "INSERT INTO B SELECT * FROM A;"]
    #
    #         for sql in sqls:
    #             manager.process_sql(sql)
    #
    #         assert (
    #             manager.storage.has_cycles() is True
    ...
    #         def setup():
    #             return [
    #                 "INSERT INTO table_{i} SELECT * FROM source_{i};" for i in range(100)
    #             ]
    #
    #         queries = setup()
    #
